...
public class FileManagerAwsService extends FileManagerService {
    ...
    @Override
    public Page<File> list(Pageable pageable, String pathId) {
        try {
            List<File> files = new ArrayList<>();
            String prefix = buildPrefix(pathId);
    ...
    @Override
    public Optional<File> get(String fileId, String pathId) {
        try {
            String key = resolveKey(fileId, pathId);
    ...
    @Override
    public File upload(MultipartFile file, String pathId, String id, String name) {
        try {
            String prefix = buildPrefix(pathId);
            String key = prefix + id + ".pdf"; 
    ...
    @Override
    public void delete(String fileId, String pathId) {
        try {
            String key = resolveKey(fileId, pathId);
    ...
    private String buildPrefix(String pathId) {
    ...
    private String resolveKey(String fileId, String pathId) {
        String prefix = buildPrefix(pathId);
        if (!StringUtils.hasText(prefix)) {
            return fileId;
        }
