...
public class UserRentalServiceImpl implements UserRentalService {
    ...
    public ResponseEntity<Void> cancelRental(String userEmail, String rentalId, CancelRentalRequestDTO request) {
        ...
        // Mock rental lookup - in real implementation would query database
        // For this example, we'll assume the rental exists and belongs to the user
        // In real implementation, you'd verify ownership and throw AccessDeniedException if not owned

        // Mock cancellation logic
        // In real implementation, would update rental status in database
